...
public class Game {
    ...
    public Game init() {
        if (!loadSave()) {
            ...
            // TODO init boards
            Board b1, b2;
            b1 = new Board(login+"'s board");
            b2 = new Board("AI board");

            // TODO init this.player1 & this.player2
            List<AbstractShip> shipsPlayer = createDefaultShips();
            List<AbstractShip> shipsAI = createDefaultShips();

            this.player1 = new Player(b1, b2, shipsPlayer);
            this.player2 = new AIPlayer(b2, b1, shipsAI);
