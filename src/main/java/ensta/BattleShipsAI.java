    ...
    public void putShips(AbstractShip ships[]) {
        ...
        for (AbstractShip s : ships) {
            do {
                ...
                List<Orientation> listeOrientations = Arrays.asList(orientations);
                o = listeOrientations.get(rnd.nextInt(listeOrientations.size()));
                s.setOrientation(o);

                int[] coordonnees = pickRandomCoord();
                x= coordonnees[0];
                y= coordonnees[1];
